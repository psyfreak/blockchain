...
# Issues & Solution
## Bitcoin Client Testnet was not able to sign the message 
Isn't this a testnet SegWit address? You can't sign message from those. https://bitcointalk.org/index.php?topic=3225732.0
- arrow function in promise why self???
- https://stackoverflow.com/questions/43895473/promise-inside-promise-whats-the-correct-way-to-return-a-variable-from-the-child
  use awaits or ...
- added owner to data/body of the block

Maybe someone else has/had the same issues:
I tried to submit a star and try to sign the message.

I tried to sign a message in bitcoin client testnet => signing did not work / address not found
I switched to Electrum client and tried to sign there, which worked, but when I used the data in my post I got an exception in bitcoinMessage library: Error: Non-base58 character
I read here: https://bitcointalk.org/index.php?topic=3225732.0 that it seems I have a SegWit address and I need a legacy one...
Solution:
So my current solution is to run the command "getnewaddress '' legacy" in bitcoin console, which creates a legacy address.
This address can then be used to sign the message in bitcoint wallet and also works in the library to finally submit a star.

Has someone found a better solution maybe to create a legacy wallet right from the start ...

getnewaddress "jo" legacy
mtu2KgGGpSNo1eemN5x6e1MotN6TMxBB3o

- used Electron wallet => got a non58-Character-error
- time/message proof of existence
- promisses